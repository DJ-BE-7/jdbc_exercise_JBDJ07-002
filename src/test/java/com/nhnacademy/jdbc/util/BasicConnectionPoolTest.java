...
class BasicConnectionPoolTest {
    ...
    static void setUp() {
        ...
        basicConnectionPool = new BasicConnectionPool(com.mysql.cj.jdbc.Driver.class.getName(),"jdbc:mysql://133.186.241.167:3306/nhn_academy_102","nhn_academy_102","cM2godls!",5);
    }
